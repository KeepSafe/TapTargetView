...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        droidTarget.offset(display.widthPixels / 2, display.heightPixels / 2)
        ...
        val sequence = TapTargetSequence(this)
                ...
                .listener(object : TapTargetSequence.Listener {
                    ...
                    override fun onSequenceFinish() {
                        (findViewById<TextView>(R.id.educated)).text = getString(R.string.success_educate_message)
                    }
                    ...
                    override fun onSequenceCanceled(lastTarget: TapTarget) {
                        val dialog = AlertDialog.Builder(this@MainActivity)
                                .setTitle("Uh oh")
                                .setMessage(getString(R.string.cancel_sequence_message))
        ...
        TapTargetView.showFor(this,
                TapTarget.forView(findViewById<View>(R.id.fab), getString(R.string.hello_world_text), spannedDesc)
                        .cancelable(false)
                        .drawShadow(true)
                ...
                object : TapTargetView.Listener() {
                    ...
                    override fun onOuterCircleClick(view: TapTargetView) {
                        ...
                        Toast.makeText(view.context, getString(R.string.outer_circle_click_toast_message), Toast.LENGTH_SHORT).show()
                    }

                    override fun onTargetDismissed(view: TapTargetView, userInitiated: Boolean) {
                        Log.d("TapTargetViewSample", getString(R.string.fab_dismissed_message))
                    }
                }
        )
    }
